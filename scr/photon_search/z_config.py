...
#PROCESSED_DATA_PATH = Path('/home/anna/photon_detection/ML/Creating and Verifying Training Sets/Training set #7/gw_tale_mc_all.testing_data_007.csv' )
#OUTPUT_DATA_PATH = Path(''/home/anna/photon_detection/ML/results_output.csv')
